...
#     # count += 1
#     if req_type == "temperature":
#         temp_sum += metric['temperature']
#         humidity_sum += metric['humidity']
#     else:
#         co_sum += metric['co2']
#         pm_sum += metric['pm25']
# print(temp_sum, humidity_sum)
#
#       for item in ksht.values():
#             ksht_temperature = 0
#             ksht_humidity = 0
#             ksht_co = 0
#             ksht_pm = 0
#             if req_type == "temperature":
#                 ksht_temperature += item['temperature']
#                 ksht_humidity += item['humidity']
#             else:
#                 ksht_co += item['co2']
#                 ksht_pm += item['pm25']
#         for item in zavodsk.values():
#             zavodsk_temperature = 0
#             zavodsk_humidity = 0
#             zavodsk_co = 0
#             zavodsk_pm = 0
#             if req_type == "temperature":
#                 zavodsk_temperature += item['temperature']
#                 zavodsk_humidity += item['humidity']
#             else:
#                 zavodsk_co += item['co2']
#                 zavodsk_pm += item['pm25']
#         for item in zashita.values():
#             zashita_temperature = 0
#             zashita_humidity = 0
#             zashita_co = 0
#             zashita_pm = 0
#             if req_type == "temperature":
#                 zashita_temperature += item['temperature']
#                 zashita_humidity += item['humidity']
#             else:
#                 zashita_co += item['co2']
#                 zashita_pm += item['pm25']
#         for item in ulbinsk.values():
#             ulbinsk_temperature = 0
#             ulbinsk_humidity = 0
#             ulbinsk_co = 0
#             ulbinsk_pm = 0
#             if req_type == "temperature":
#                 ulbinsk_temperature += item['temperature']
#                 ulbinsk_humidity += item['humidity']
#             else:
#                 ulbinsk_co += item['co2']
#                 ulbinsk_pm += item['pm25']
#         for item in tsentr.values():
#             tsentr_temperature = 0
#             tsentr_humidity = 0
#             tsentr_co = 0
#             tsentr_pm = 0
#             if req_type == "temperature":
#                 tsentr_temperature += item['temperature']
#                 tsentr_humidity += item['humidity']
#             else:
#                 tsentr_co += item['co2']
#                 tsentr_pm += item['pm25']
async def main():
